...
namespace aima.net.environment.connectfour
{
     ...
     * 
     */
    public class ConnectFourState : ICloneable<ConnectFourState>, IEquatable
    {
        ...
        public bool isWinMoveFor(int col, int playerNum)
        {
            return isWinPositionFor(getFreeRow(col), col, playerNum);
        }

        public bool isWinPositionFor(int row, int col, int playerNum)
        {
        ...
        private void setWinPositionFor(int row, int col, int playerNum)
        {
            ...
            board[row * cols + col] |= (byte)(playerNum * 4);
        }
        ...
        public int analyzePotentialWinPositions(int action)
        {
            int[] rowIncr = new int[] { 1, 0, 1, 1 };
            int[] colIncr = new int[] { 0, 1, -1, 1 };
            int moveCol = action;
        ...
        public ConnectFourState Clone()
        {
            ...
            result.winPositions2 = winPositions2;
        ...
        {
            int result = 0;
            foreach (byte aBoard in board) result = result * 7 + aBoard + 1;
            return result;
        }
