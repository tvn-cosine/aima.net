...
{
    public interface CategoricalDistributionIterator : IIterator
    {  }
     ...
     */
    public interface ICategoricalDistribution : IProbabilityMass
    { 
        /**
         ...
         */
        int getIndex(params object[] values);
         ...
         *         values.
         */
        ICategoricalDistribution marginal(params IRandomVariable[] vars);
         ...
         *             of the dividend.
         */
        ICategoricalDistribution divideBy(ICategoricalDistribution divisor);
         ...
         */
        ICategoricalDistribution multiplyBy(ICategoricalDistribution multiplier);
         ...
         */
        ICategoricalDistribution multiplyByPOS(ICategoricalDistribution multiplier, params IRandomVariable[] prodVarOrder);
         ...
         */
        void iterateOver(CategoricalDistributionIterator cdi);
         ...
         */
        void iterateOver(CategoricalDistributionIterator cdi, params AssignmentProposition[] fixedValues);
    }
}
