...
namespace aima.net.test.unit.environment.eightpuzzle
{
    ...
    public class EightPuzzleBoardMoveTest
    {
        ...
        {
            Assert.AreEqual(false, board.canMoveGap(EightPuzzleBoard.UP));
            Assert.AreEqual(true, board.canMoveGap(EightPuzzleBoard.DOWN));
            Assert.AreEqual(false, board.canMoveGap(EightPuzzleBoard.LEFT));
            Assert.AreEqual(true, board.canMoveGap(EightPuzzleBoard.RIGHT));
        }
        ...
        {
            board.moveGapDown();
            Assert.AreEqual(new EightPuzzleBoard(new int[] { 6, 5, 4, 0, 1, 8,
                7, 3, 2 }), board);
        }
        ...
        {
            board.moveGapRight();
            Assert.AreEqual(new EightPuzzleBoard(new int[] { 5, 0, 4, 6, 1, 8,
                7, 3, 2 }), board);
        }
        ...
        public void testPosition2Movabilty()
        {
            ...
            Assert.AreEqual(false, board.canMoveGap(EightPuzzleBoard.UP));
            Assert.AreEqual(true, board.canMoveGap(EightPuzzleBoard.DOWN));
            Assert.AreEqual(true, board.canMoveGap(EightPuzzleBoard.LEFT));
            Assert.AreEqual(true, board.canMoveGap(EightPuzzleBoard.RIGHT));
        }
        ...
        public void testPosition2MoveDown()
        {
            ...
            setGapToPosition2();
            board.moveGapDown();
            Assert.AreEqual(new EightPuzzleBoard(new int[] { 5, 1, 4, 6, 0, 8,
                7, 3, 2 }), board);
        }
        ...
        public void testPosition2MoveRight()
        {
            ...
            setGapToPosition2();
            board.moveGapRight();
            Assert.AreEqual(new EightPuzzleBoard(new int[] { 5, 4, 0, 6, 1, 8,
                7, 3, 2 }), board);
        }
        ...
        public void testPosition3Movabilty()
        {
            ...
            Assert.AreEqual(true, board.canMoveGap(EightPuzzleBoard.DOWN));
            Assert.AreEqual(true, board.canMoveGap(EightPuzzleBoard.LEFT));
            Assert.AreEqual(false, board.canMoveGap(EightPuzzleBoard.RIGHT));
        }
        ...
        public void testPosition3MoveDown()
        {
            ...
            setGapToPosition3();
            board.moveGapDown();
            Assert.AreEqual(new EightPuzzleBoard(new int[] { 5, 4, 8, 6, 1, 0,
                7, 3, 2 }), board);
        }
        ...
        {
            setGapToPosition4();
            Assert.AreEqual(true, board.canMoveGap(EightPuzzleBoard.UP));
            Assert.AreEqual(true, board.canMoveGap(EightPuzzleBoard.DOWN));
            Assert.AreEqual(false, board.canMoveGap(EightPuzzleBoard.LEFT));
            Assert.AreEqual(true, board.canMoveGap(EightPuzzleBoard.RIGHT));
        }
        ...
        public void testPosition4MoveDown()
        {
            ...
            setGapToPosition4();
            board.moveGapDown();
            Assert.AreEqual(new EightPuzzleBoard(new int[] { 6, 5, 4, 7, 1, 8,
                0, 3, 2 }), board);
        }
        ...
        public void testPosition4MoveRight()
        {
            ...
            setGapToPosition4();
            board.moveGapRight();
            Assert.AreEqual(new EightPuzzleBoard(new int[] { 6, 5, 4, 1, 0, 8,
                7, 3, 2 }), board);
        }
        ...
        public void testPosition5MoveUp()
        {
            ...
            setGapToPosition5();
            board.moveGapUp();
            Assert.AreEqual(new EightPuzzleBoard(new int[] { 6, 0, 4, 1, 5, 8,
                7, 3, 2 }), board);
        }
        ...
        public void testPosition5MoveDown()
        {
            ...
            setGapToPosition5();
            board.moveGapDown();
            Assert.AreEqual(new EightPuzzleBoard(new int[] { 6, 5, 4, 1, 3, 8,
                7, 0, 2 }), board);
        }
        ...
        public void testPosition5MoveRight()
        {
            ...
            setGapToPosition5();
            board.moveGapRight();
            Assert.AreEqual(new EightPuzzleBoard(new int[] { 6, 5, 4, 1, 8, 0,
                7, 3, 2 }), board);
        }
        ...
        public void testPosition6MoveUp()
        {
            ...
            setGapToPosition6();
            board.moveGapUp();
            Assert.AreEqual(new EightPuzzleBoard(new int[] { 6, 5, 0, 1, 8, 4,
                7, 3, 2 }), board);
        }
        ...
        public void testPosition6MoveDown()
        {
            ...
            setGapToPosition6();
            board.moveGapDown();
            Assert.AreEqual(new EightPuzzleBoard(new int[] { 6, 5, 4, 1, 8, 2,
                7, 3, 0 }), board);
        }
        ...
        public void testPosition7Movabilty()
        {
            setGapToPosition7();
            Assert.AreEqual(true, board.canMoveGap(EightPuzzleBoard.UP));
            Assert.AreEqual(false, board.canMoveGap(EightPuzzleBoard.DOWN));
            Assert.AreEqual(false, board.canMoveGap(EightPuzzleBoard.LEFT));
            Assert.AreEqual(true, board.canMoveGap(EightPuzzleBoard.RIGHT));
        }
        ...
        public void testPosition8MoveUp()
        {
            ...
            setGapToPosition8();
            board.moveGapUp();
            Assert.AreEqual(new EightPuzzleBoard(new int[] { 6, 5, 4, 7, 0, 8,
                3, 1, 2 }), board);
        }
        ...
        public void testPosition9MoveUp()
        {
            ...
            setGapToPosition9();
            board.moveGapUp();
            Assert.AreEqual(new EightPuzzleBoard(new int[] { 6, 5, 4, 7, 1, 0,
                3, 2, 8 }), board);
        }
